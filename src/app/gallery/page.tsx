...
const galleryItems = [
    ...
    },
    {
        ...
        longDescription: 'Nos croissants, c\'est des heures de préparation pour 3 minutes de bonheur ! Pâte feuilletée au beurre AOP (on ne lésine pas), façonnage à la main, cuisson dorée à point... Le résultat ? Ce "croc" parfait qui réveille tout le quartier et cette mie aérée qui fond sur la langue. Disponibles tant qu\'il y en a, et croyez-nous, ça part vite !',
    ...
    },
    {
        ...
        longDescription: 'Vous voulez épater vos invités ? Nos trompe-l\'œil sont votre arme secrète ! Cette "boîte à bijoux" ? C\'est un gâteau aux fruits rouges. Ce "livre ancien" ? Un délicieux chocolat-praliné. Nos maîtres-illusionnistes façonnent chaque détail : texture, couleur, relief... jusqu\'à la perfection trompeuse ! Le résultat : des "Oh !" et des "Ah !" garantis, suivis d\'un silence religieux quand vos invités découvrent le goût. Magie pure !',
    ...
    },
    {
        ...
        longDescription: 'Nos tartelettes, c\'est le bonheur en format mini !  variétés colorées dans chaque plateau : tarte citron meringuée, fraise-basilic, framboise fraîche, fruits exotique. Parfait pour épater sans se ruiner :impossible de n\'en prendre qu\'une.',
    ...
    },
    {
        ...
        longDescription: 'Nos cookies, c\'est du 100% fait-maison, Recette grand-mère revisitée par notre chef : pâte au beurre français, cuisson parfaite (croustillant dehors, moelleux dedans), et ces 3 saveurs qui rendent accro : noisette-chocolat (notre bestseller), framboise acidulée, pistache de Sicile.',
    ...
    },
    {
        ...
        longDescription: 'Notre tarte aux fraises, c\'est l\'été belge dans une assiette ! Pâte sablée croustillante (secret familial depuis 3 générations), crème pâtissière vanille Bourbon, et ces fraises de Wépion qui font notre fierté nationale. Disponible en version individuelle (parfait pour un tête-à-tête) ou familiale 8 parts (idéal dimanche chez belle-maman).',
    ...
    },
    {
        ...
        longDescription: 'Nos baguettes, c\'est de la France livrée à Bruxelles ! Cuites plusieurs fois par jour. Croûte dorée qui craque, mie alvéolée qui sent bon le blé. Nos clients français nous disent : "Enfin du vrai pain !" Nos clients belges : "Pourquoi on n\'en faisait pas avant ?" Mystère résolu !',
